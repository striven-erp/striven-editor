...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(2), __webpack_require__(6), __webpack_require__(7), __webpack_require__(8), __webpack_require__(9), __webpack_require__(10), __webpack_require__(11), __webpack_require__(12), __webpack_require__(13), __webpack_require__(14), __webpack_require__(15), __webpack_require__(16), __webpack_require__(17), __webpack_require__(18), __webpack_require__(19), __webpack_require__(20), __webpack_require__(21), __webpack_require__(22)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _fontawesomeSvgCore, _faFont, _faBold, _faItalic, _faUnderline, _faStrikethrough, _faList, _faListOl, _faListUl, _faAlignJustify, _faIndent, _faAlignLeft, _faAlignCenter, _faAlignRight, _faPaperclip, _faLink, _faImage, _faPaperPlane) {
  "use strict";
  ...
  _fontawesomeSvgCore.library.add(_faFont.faFont);

  _fontawesomeSvgCore.library.add(_faBold.faBold);

  _fontawesomeSvgCore.library.add(_faItalic.faItalic);

  _fontawesomeSvgCore.library.add(_faUnderline.faUnderline);

  _fontawesomeSvgCore.library.add(_faStrikethrough.faStrikethrough);

  _fontawesomeSvgCore.library.add(_faList.faList);

  _fontawesomeSvgCore.library.add(_faListOl.faListOl);

  _fontawesomeSvgCore.library.add(_faListUl.faListUl);

  _fontawesomeSvgCore.library.add(_faAlignJustify.faAlignJustify);

  _fontawesomeSvgCore.library.add(_faIndent.faIndent);

  _fontawesomeSvgCore.library.add(_faAlignLeft.faAlignLeft);

  _fontawesomeSvgCore.library.add(_faAlignCenter.faAlignCenter);

  _fontawesomeSvgCore.library.add(_faAlignRight.faAlignRight);

  _fontawesomeSvgCore.library.add(_faPaperclip.faPaperclip);

  _fontawesomeSvgCore.library.add(_faLink.faLink);

  _fontawesomeSvgCore.library.add(_faImage.faImage);

  _fontawesomeSvgCore.library.add(_faPaperPlane.faPaperPlane);
    ...
    _createClass(StrivenEditor, [{
        ...
        this.body.onpaste = function (e) {
          ...
          if (e.clipboardData.files.length > 0 && e.clipboardData.files[0].type.includes("image")) {
            convertImage(e.clipboardData.files[0]).then(function (res) {
              ...
              _this.options.uploadOnPaste && _this.attachFile(dataURLtoFile(res, "pastedimage"));
          ...
          if (e.clipboardData.items.length > 0 && e.clipboardData.items[0].type === "text/plain") {
            e.clipboardData.items[0].getAsString(function (string) {
              if (_this.options.metaUrl && _this.validURL(string)) {
                _this.getMeta(string).then(function (res) {
                  var url = res.url,
                      title = res.title,
                      image = res.image,
                      description = res.description;
                  url && title && image && _this.createMetaDataElement(url, image, title, description);
                });
              }
            });
          }
      ...
      value: function initToolbar() {
        ...
        groups.forEach(function (group) {
          ...
          var toolbarMenu = document.createElement("div");
          var toolbarMenuIcon = document.createElement("i");
          toolbarMenu.classList.add("toolbar-menu");
          toolbarMenu.id = "menu-".concat(group);
          toolbarMenuIcon.classList.add(_this2.options.fontPack);
          toolbarMenuIcon.classList.add(_this2.optionGroups[group].menu);
          ...
          _this2.optionGroups[group].group.forEach(function (option) {
            ...
            optionIcon.classList.add(_this2.options.fontPack);
        ...
        var toolbarSend = document.createElement("div");
        var toolbarSendIcon = document.createElement("i");
      ...
      value: function initLinkMenu() {
        ...
        linkMenuButton.onclick = function (e) {
          ...
          if (linkValue) {
            ...
            window.getSelection().addRange(_this3.range);
            document.execCommand("createLink", true, linkValue);

            if (_this3.options.metaUrl && _this3.validURL(linkValue)) {
              _this3.getMeta(linkValue).then(function (res) {
                var url = res.url,
                    image = res.image,
                    title = res.title,
                    description = res.description;
                url && image && title && _this3.createMetaDataElement(url, image, title, description);
              });
            }

            var bodyLinks = _this3.body.querySelectorAll("a");

            bodyLinks[bodyLinks.length - 1].contentEditable = "false";
            linkMenuFormInput.value = "";

            _this3.toolbar.querySelector("#toolbar-link").onclick();
          } else {
            _this3.body.focus();

            _this3.closeLinkMenu();
          }
        };
      ...
      value: function initImageMenu() {
        ...
        imageMenuButton.onclick = function (e) {
          ...
          if (linkValue) {
            ...
            var imageTags = _this4.body.querySelectorAll("img");
            ...
            _this4.toolbar.querySelector("#toolbar-image").onclick();
          } else {
            _this4.body.focus();

            _this4.closeImageMenu();
          }
        };
      ...
      value: function initFilesSection() {
        ...
        this.body.ondragenter = function (e) {
          _this5.body.style.backgroundColor = "#ddd";
        };

        this.body.ondragleave = function (e) {
          _this5.body.style.backgroundColor = "inherit";
        };
        ...
        this.body.ondrop = function (e) {
          ...
          _this5.attachFile(file);
        };

        this.editor.getfiles = function () {
          return _this5.getFiles();
        };
      ...
      value: function createFileElement(name, size) {
        ...
        removeFileEl.onclick = function (e) {
          _this6.files.splice(e.target.parentElement.dataset.fileindex, 1);
      ...
      value: function initResponsive() {
        ...
        if (!this.options.minimal) {
          ...
          window.onresize = function () {
            _this7.toolbarGroups.forEach(function (group) {
              return group.style.padding = "0";
            });

            _this7.closeLinkMenu();

            _this7.closeImageMenu();
      ...
      value: function fileInvalid() {
        ...
        setTimeout(function () {
          _this9.body.style.backgroundColor = "inherit";
          setTimeout(function () {
            return _this9.body.style.transition = "none";
          }, 500);
        }, 500);
      }
    }, {
