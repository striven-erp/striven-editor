    ...
    _createClass(StrivenEditor, [{
      ...
      value: function initToolbar() {
        ...
        if (this.options.customToolbarButton) {
          ...
          customToolbarButton.onclick = function () {
            return _this2.options.customToolbarButton.handler();
          };

          !this.options.toolbarHide && (customToolbarButton.style.display = "flex");

          customToolbarButton.onmouseenter = function () {
            customToolbarButton.style.borderColor = _this2.options.customToolbarButton.hoverBorderColor;
            customToolbarButton.style.backgroundColor = _this2.options.customToolbarButton.hoverBackgroundColor;
            customToolbarButton.style.color = _this2.options.customToolbarButton.hoverColor;
          };

          customToolbarButton.onmouseleave = function () {
            customToolbarButton.style.borderColor = _this2.options.customToolbarButton.borderColor;
            customToolbarButton.style.backgroundColor = _this2.options.customToolbarButton.backgroundColor;
            customToolbarButton.style.color = _this2.options.customToolbarButton.color;
          };
      ...
      value: function initBody() {
        ...
        if (this.options.placeholder) {
          ...
          body.onfocus = function () {
            bodyFocus && bodyFocus();
            body.querySelector("#placeholder-node") === placeholderNode && _this3.clearContent();
          };
          ...
          body.onblur = function () {
            bodyBlur && bodyBlur();
            _this3.getContent().trim() === "" && body.append(placeholderNode);
          };
        } // Paste Handler
        ...
        body.onpaste = function (e) {
          ...
          if (e.clipboardData.files.length > 0 && e.clipboardData.files[0].type.includes("image")) {
            convertImage(e.clipboardData.files[0]).then(function (res) {
              if (_this3.options.imageUrl) {
                _this3.getImage(res).then(function (data) {
          ...
          if (_this3.options.sanitizePaste && e.clipboardData.types.includes("text/html")) {
            e.preventDefault();
            var pastedHtmlItem;
            ...
            if (pastedHtmlItem) {
              pastedHtmlItem.getAsString(function (htmlString) {
                ...
                range.insertNode(_this3.scrubHTML(htmlString));
                range.collapse();
              });
            }
        ...
        body.onkeyup = function (e) {
          ...
          if (_this3.options.submitOnEnter && e.keyCode === 13 && !e.shiftKey) {
            var content = _this3.getContent();

            var hasText = !!_this3.getTextContent();

            var files = _this3.getFiles();

            var hasImage = !!body.querySelector('img');
      ...
      value: function initImageMenu() {
        ...
        imageMenuButton.onclick = function (e) {
          ...
          if (linkValue) {
            ...
            var insertedImage = _toConsumableArray(_this5.body.querySelectorAll("img")).filter(function (img) {
      ...
      value: function toolbarState() {
        ...
        this.options.toolbarOptions.forEach(function (option) {
          var toolbarOption = _this11.toolbar.querySelector("#toolbar-".concat(option));

          if (!option.includes('justify') && !option.includes('list')) {
            if (document.queryCommandState(option)) {
              toolbarOption.querySelector('path').setAttribute('fill', _this11.options.activeOptionColor);
            } else {
