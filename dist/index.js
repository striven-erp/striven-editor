    ...
    _createClass(StrivenEditor, [{
      ...
      value: function initToolbar() {
        ...
        groups.forEach(function (group) {
          ...
          _this2.optionGroups[group].group.forEach(function (option) {
            var toolbarCommand = Object.keys(option)[0];

            var optionSpan = _this2.constructSVG(option[toolbarCommand]); // const optionIcon = document.createElement("i");


            optionSpan.id = "toolbar-".concat(toolbarCommand);
            optionSpan.style.margin = "0 10px"; // optionIcon.classList.add(this.options.fontPack);
          ...
          _this2.toolbarOptionsGroup.appendChild(toolbarGroup);
        });
