        ...
        function (t, e, o) {
            ...
            function f(t) {
                return t instanceof Element
                    ? t
                    : 'string' == typeof t
                      ? t.split(/>>/g).reduce((t, e, o, n) => ((t = t.querySelector(e)), o < n.length - 1 ? t.shadowRoot : t), document)
                      : null;
            }
            function m(t, e = (t) => t) {
                function o(o) {
                    ...
                    let i = 0,
                        r = t.selectionStart;
                    (t.value = t.value.replace(/[\d.]+/g, (t, o) => (o <= r && o + t.length >= r ? ((r = o), e(Number(t), n, i)) : (i++, t)))),
                        t.focus(),
                        t.setSelectionRange(r, r),
                        o.preventDefault(),
                        t.dispatchEvent(new Event('input'));
                }
                c(t, 'focus', () => c(window, 'wheel', o, { passive: !1 })), c(t, 'blur', () => a(window, 'wheel', o));
            }
            var v = o(0);
            ...
            function k(t, e, o, n) {
                return (
                    (e /= 100),
                    (o /= 100),
                    [...C(255 * (1 - b(1, (t /= 100) * (1 - (n /= 100)) + n)), 255 * (1 - b(1, e * (1 - n) + n)), 255 * (1 - b(1, o * (1 - n) + n)))]
                );
            }
            function S(t, e, o) {
                return (e /= 100), [t, ((2 * (e *= (o /= 100) < 0.5 ? o : 1 - o)) / (o + e)) * 100, 100 * (o + e)];
            }
            function O(t) {
                        ...
                        toCMYK() {
                            const t = (function (t, e, o) {
                                ...
                                return (
                                    ...
                                    (l = 1 === c ? 0 : (1 - r - c) / (1 - c)),
                                    (p = 1 === c ? 0 : (1 - s - c) / (1 - c)),
                                    [100 * a, 100 * l, 100 * p, 100 * c]
                                );
                            })(r.h, r.s, r.v);
                            return (
                                (t.toString = i(t, (t) => 'cmyk('.concat(t[0], '%, ').concat(t[1], '%, ').concat(t[2], '%, ').concat(t[3], '%)'))), t
                            );
                        },
                        toHEXA() {
                            const t = (function (t, e, o) {
            ...
            function L(t) {
                const e = {
                        ...
                        _tapmove(t) {
                            ...
                            'h' !== n && (r.style.left = 'calc('.concat((a / c.width) * 100, '% - ').concat(r.offsetWidth / 2, 'px)')),
                                'v' !== n && (r.style.top = 'calc('.concat((l / c.height) * 100, '% - ').concat(r.offsetHeight / 2, 'px)')),
                        ...
                        destroy() {
                            ...
                            a([t.wrapper, t.element], 'mousedown', o), a([t.wrapper, t.element], 'touchstart', o, { passive: !1 });
                        }
                    },
            ...
            function B({ el: t, reference: e, padding: o = 8 }) {
                ...
                return {
                    update(s, c = !1) {
                        ...
                        c
                            ? ((t.style.top = ''.concat((window.innerHeight - h.height) / 2, 'px')),
                              (t.style.left = ''.concat((window.innerWidth - h.width) / 2, 'px')))
            ...
            class R {
                ...
                _preBuild() {
                    ...
                    (this._root = (({ components: t, strings: e, useAsButton: o, inline: n, appClass: i, theme: r, lockOpacity: s }) => {
                        ...
                        return (
                            ...
                            (l.type = () => l.options.find((t) => t.classList.contains('active'))),
                            a
                        );
                    })(t)),
                        ...
                        s = {
                            ...
                            hue: L({
                                ...
                                onchange(o) {
                                    ...
                                    const n = r();
                                    t._recalc && (n.h = 360 * o),
                                        (this.element.style.backgroundColor = 'hsl('.concat(n.h, ', 100%, 50%)')),
                                        s.palette.trigger();
                                }
                            }),
                            opacity: L({
                                ...
                                onchange(o) {
                                    ...
                                    t._recalc && (n.a = Math.round(100 * o) / 100),
                                        (this.element.style.background = 'rgba(0, 0, 0, '.concat(n.a, ')')),
                                        s.palette.trigger();
                                }
                            }),
                            selectable: P({
                ...
                addSwatch(t) {
                    ...
                    if (e) {
                        const { _swatchColors: t, _root: o } = this,
                            n = x(...e),
                            i = p('<button type="button" style="color: '.concat(n.toRGBA().toString(0), '" aria-label="color swatch"/>'));
                        return (
                ...
                show() {
                    return (
                        this.options.disabled || (this._root.app.classList.add('visible'), this._rePositioningPicker(), this._emit('show', this)),
                        this
                    );
                }
                isOpen() {
                ...
                setColorRepresentation(t) {
                    return (
                        (t = t.toUpperCase()), !!this._root.interaction.options.find((e) => e.getAttribute('data-type').startsWith(t) && !e.click())
                    );
                }
            ...
            (R.utils = n), (R.libs = { HSVaColor: x, Moveable: L, Nanopop: B, Selectable: P }), (R.create = (t) => new R(t)), (R.version = v.a);
            e.default = R;
        }
    ]).default;
});
